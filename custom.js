...
$contactForm.submit(
  function (e) {
    ...
    if (honeyPotValue === '') {
      $.ajax({
        url: 'https://bryanhanner.com/' + FORMSPREE_EMAIL,
        method: 'POST',
...
*/
$(document).ready(function(){
  $('.plan-a').attr('href', 'https://www.bryanhanner.com')
  $('.plan-b').attr('href', 'https://www.bryanhanner.com')
  $('.plan-c').attr('href', 'https://www.bryanhanner.com')
});
